...
CREATE TABLE jobs (
  job_ref VARCHAR(5) PRIMARY KEY,          -- e.g., A1034
...
-- Sample jobs 
INSERT INTO `jobs` (`job_ref`, `title`, `category`, `location`, `remote`, `job_type`, `salary`, `reporting_line`, `description`, `responsibilities`, `essential_req`, `preferrable_req`, `opening_date`, `closing_date`) 
VALUES
